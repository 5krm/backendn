...
use App\Support\MediaLibrary\CoursePathGenerator;
use App\Support\MediaLibrary\LessonResourcePathGenerator;
...
return [
    ...
    'custom_path_generators' => [
        LessonResource::class => LessonResourcePathGenerator::class,
        Course::class => CoursePathGenerator::class,
    ],
